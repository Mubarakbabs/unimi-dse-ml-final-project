#first tree handling only numeric values
import numpy as np
import pandas as pd
...
class DecisionTree:
    ...
    def _most_common_label(self,y):
        ...
        #print(f"Counter object: {counter.most_common}")
        ...
        # Find the unique value(s) with the maximum count
        value = unique_values[counts == max_count]
